...
import { setChecked } from '@/app/redux/paymentReducer'


const Terms_conditions =  () => {
    const dispatch = useDispatch()
    const { checked } = useSelector(state => state.payment)
    ...
    return (
        ...
        <div className='grid md:grid-cols-2 gap-10 box-shadow rounded-[23px] lg:p-16 p-10 flex-col md:flex-row z-10 bg-white'>
            ...
            <div className='pt-10'>
                    <input type="checkbox"  className="border-[#FF8500] border h-6 w-6 " value={checked} onChange={(e) => dispatch(setChecked(e.target.checked)) } />
