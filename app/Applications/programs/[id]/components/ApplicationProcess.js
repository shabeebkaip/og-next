...
import { fadeIn, fadeOut, staggerContainer } from '../../../../constant/motion';
    ...
    <div className='container relative px-6 py-32 mx-auto md:px-0 '>
      ...
      <div className='flex flex-col items-center justify-center gap-16 xl:gap-28 font-Sans'>
        ...
        <motion.div
          ...
          initial="hidden"
          whileInView={"show"}
          className='xl:text-[50px] text-center md:leading-[75px] leading-[44px] text-[#4C4C4D] font-medium md:text-[40px] text-[34px]'>
