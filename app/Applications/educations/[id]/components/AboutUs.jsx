    ...
    return (
        <div className='p-3 mt-20'>
            ...
            <div className="flex">
                ...
                <div className='absolute h-[300px] w-[300px] -right-0  -bottom-[180%] z-10 md:block hidden'><BlueGradient /></div>
                ...
                <div className='container mx-auto lg:flex  rounded-[23px] drop-shadow-xl   p-4  bg-white 2xl:pt-0 2xl:pb-0 2xl:pr-0 h-auto pt-0 md:p-2 lg:pt-0 lg:pr-0 lg:pb-0 md:pb-0 mt-14  '>
                    ...
                    <div className='absolute h-[300px] w-[300px] -left-[10%]  -bottom-[180%] hidden lg:block'><OrangeGradient /></div>
