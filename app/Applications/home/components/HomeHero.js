...
// import { arabic_translation } from '../../../constant'
  ...
  return (
    <div
      ...
      <motion.div
        ...
        initial="hidden"
        whileInView={"show"}
        className='flex lg:w-[55%] w-full flex-col bg-white box-shadow rounded-[23px] justify-center  gap-10 relative z-1000' >
        ...
        <div className='ml-[15%] pb-5  '>
          <Link href="/programs">
          <button className='border px-9 py-3 rounded-[40px] border-[#FF8500] text-[20px] text-[#1C2126]' onClick={() => handleNavigation('/programs')}>
            Our Programs
